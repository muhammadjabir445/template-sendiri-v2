<?php /* Template Name: android-skill-basic */ ?>
...
<div class="head android-basic text-center text-white">
        <div class="container text-left">
            ...
            <img style="" src="https://redhunter.id/wp-content/uploads/2020/09/box-Basic-Android-Hunter-b1.png" alt="">
        </div>
            ...
            <div class="text-detail soft-id aktive" style="padding-top: 40px;" data-id="soft-id">
                <div class="row">
                    <div class="col-12 col-md-4">
                        <img src="https://redhunter.id/wp-content/uploads/2020/09/box-modul-flashdicsk-android-1.png" alt="" class="img-fluid">
                    </div>
