<?php /* Template Name: android-karir */ ?>
...
<div class="head android text-center text-white">
        <div class="container">
    ...
    <div class="content text-center">
                ...
                <div class="col-12 col-md-4">
                    <div class="content-level">
                        ...
                        <div>
                            ...
                            <br>
                            <span class="sub-judul">Beginner, Intermediate,
                                Expert</span>
                        </div>
                    </div>
        ...
        <div class="tentang-kami container" id="learn">
            ...
            <div class="menu text-center text-white">
                ...
                <a href="#" class="btn text-white btn-program-route aktive" data-id="beginner-id">Beginner Level</a> 
            
                <a href="#" class="btn text-white btn-program-route" data-id="intermediate-id">Intermediate Level</a> 
                <a href="#" class="btn text-white btn-program-route" data-id="expert-id">Expert Level</a> 
            ...
            <div class="text-detail aktive  beginner-id" data-id="beginner-id">
                <div class="row text-detail-card">
                    <div class="col-12 col-md-4">
                        <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/box-modul-flashdicsk-android-1.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-12 col-md-8 text-left">
                        <p class="judul-courses">Basic Android Hunter</p>
                        <p style="" class="deskripsi">
                            Kamu mempelajari setiap dasar codingan Android menggunakan bahasa pemrograman Java. Android sangat bergantung kepada sifat-sifat dasar dari Java tersebut. Android SDK mengandung banyak library Java standar (library struktur data, library matematika, library grafik, library networking dan apapun yang dapat Anda inginkan) dan juga library special Android yang dapat membantu Anda mengembangkan aplikasi Android yang keren.
            ...
            <div class="text-detail intermediate-id text-left" data-id="intermediate-id">
                <div class="row text-detail-card">
                    <div class="col-12 col-md-4">
                        <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/box-modul-flashdicsk-android-2.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-12 col-md-8 text-left">
            ...
            <div class="text-detail expert-id" data-id="expert-id">
                <div class="row text-detail-card">
                    <div class="col-12 col-md-4">
                        <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/09/box-modul-flashdicsk-android-3.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-12 col-md-8 text-left">
                        <p class="judul-courses">Expert Android Hunter</p>
                        <p style="" class="deskripsi">
							Level terakhir dalam pelatihan Android, pada bagian ini akan mempelajari konsep-konsep pengembangan Android, serta penggunaan beberapa framework yang sangat baik dalam pengembangan Aplikasi Android. Step pembelajaran meliputi: Anko Library pada Kotlin, Jetpack Framework, Reactive Programming Android, Management Thread, Design kode dengan konsep Mvp, Using Firebase, Add Ads to Android Project, Upload to Playstore, dan Project Akhir.
</p>                    </div>
                </div>
            </div>
