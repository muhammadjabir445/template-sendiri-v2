...
<div class="head game text-center text-white">
    <div class="container">
            <h1>Tingkatkan Skill, Jadilah Profesional <br> Game 2D Developer Unity <br> Bersama RedHunter Academy</h1>
            <br>
            <p>Jadilah Profesional Game 2D Developer Unity dalam <br> waktu 3 bulan, dengan jaminan pekerjaan!</p>
            <br>
            <br>
            <div class="button">
    ...
    <div class="content text-center">
        ...
        <div class="tentang-kami container">
			<div class="judul">
                ...
                <p>Kamu akan mempelajari secara lengkap pemrograman dan algoritma untuk menjadi seorang Game Maker yang handal.
                </p>
            </div>
            ...
            <div class="text-detail aktive  beginner-id" data-id="beginner-id">
                <div class="row text-detail-card">
                    <div class="col-12 col-md-4">
                        <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/01/banner_skill_game01.png" alt="" class="img-fluid">
                    </div>
            ...
            <div class="text-detail intermediate-id text-left" data-id="intermediate-id">
                <div class="row text-detail-card">
                    <div class="col-12 col-md-4">
                        <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/01/banner_skill_game02.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-12 col-md-8 text-left">
...
3. Pengenalan Remote Procedure Call
            ...
            <div class="text-detail expert-id" data-id="expert-id">
                <div class="row text-detail-card">
                    <div class="col-12 col-md-4">
                        <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/01/banner_skill_game03.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-12 col-md-8 text-left">
                        <p class="judul-courses">Game Development 2D For Advanced
Hunter</p>
                        <p class="deskripsi">
							Ingin memiliki Game 2D online sendiri?
Tidak perlu pusing memikirkan cara membangun server sendiri karena kita menggunakan aplikasi Photon untuk menyiapkannya untuk kita.
